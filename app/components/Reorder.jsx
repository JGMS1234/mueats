        ...
        <div className='w-120 h-30 mt-4 mb-12 flex gap-2 relative rounded-4xl items-center py-2 bg-(--primary-colour) cursor-pointer hover:scale-105 active:scale-95 transition-all duration-200 ease-in-out'>
            ...
            <div className='px-4 py-6 h-30 w-90 bg-(--secondary-colour) rounded-r-2xl text-sm'>
                <div className='flex align-items: center'>
                    <span className='opacity-75 font-semibold'>Jockey Club Campus Canteen</span>
                    <span className='pl-12 opacity-75 font-semibold'>HK$ 46.5</span>
                </div>
                <div className='mt-2'>
                    <span className='opacity-40 font-semibold text-xs'>Ordered on 11 Mar 2026</span>
                </div>
                <div className='mt-2 flex gap-2'>
                    <span className='opacity-75 font-semibold'>Ramen with gillette fried oysters in black
garlic oil</span>
                </div>
            </div>
        </div>
