				...
				<div className='px-4 py-6 h-30 w-90 bg-(--secondary-colour) rounded-r-2xl flex justify-between items-center'>
					...
					<div>
						<button
							...
							className='bg-(--primary-colour) text-(--text-colour) font-bold py-2 px-4 rounded cursor-pointer hover:scale-100 scale-95 active:scale-95 transition-all duration-200 ease-in-out'>
							Add to Cart
						</button>
					</div>
				</div>
