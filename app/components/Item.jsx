...
export class Item extends Component {
  render() {
    ...
    return (
      <div key={product.id} className='my-8 w-120 h-30 flex gap-2 relative rounded-4xl items-center py-2 bg-(--primary-colour)'>
                         <Image className='size-20 absolute left-6 rounded-2xl' src={product.image} alt={product.name} />
