...
const Login = () => {
	...
	return (
		<div className='flex gap-12 justify-center'>
			...
			<div className='bg-(--secondary-colour) w-[35%] h-[420px] px-12 py-4 rounded-3xl flex flex-col items-start justify-center'>
				<div className='flex flex-col gap-8 w-[80%] items-center'>
					<div className='w-full flex gap-2 py-3 px-4 cursor-pointer whitespace-nowrap'>
						<div className='bg-white w-[100%] h-12 rounded-3xl p-2 pl-12 text-sm flex gap-2 items-center'>
							<input
					...
					<div className='flex justify-between'>
						<Link
							className='bg-(--primary-colour) text-(--text-colour) mt-6 w-40 h-12 ml-6 rounded-3xl cursor-pointer hover:scale-105 active:scale-95 transition-all duration-200 ease-in-out'
							href={'/home'}>
							Sign In
						</Link>
						<Link
